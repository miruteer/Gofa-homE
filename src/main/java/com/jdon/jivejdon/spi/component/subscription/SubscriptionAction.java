...
public interface SubscriptionAction {
	...
	void setUserConnectorAuth(UserConnectorAuth userConnectorAuth);

	void setSubscriptionNotify(SubscriptionNotify subscriptionNotify);

	void setNotifySubscribed(NotifySubscribed notifySubscribed);
