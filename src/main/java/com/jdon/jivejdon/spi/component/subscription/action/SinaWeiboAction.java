...
public class SinaWeiboAction implements SubscriptionAction {
	...
	public SinaWeiboAction(WeiboExpiredNotifyMessage weiboExpiredNotifyMessage) {
		super();
	...
	public WeiboExpiredNotifyMessage getWeiboExpiredNotifyMessage() {
		return weiboExpiredNotifyMessage;
	}
