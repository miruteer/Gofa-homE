...
@Consumer("loadForum")
public class loadForum implements DomainEventHandler {
	private final ForumAbstractFactory forumAbstractFactory;

	public loadForum(ForumAbstractFactory forumAbstractFactory) {
		super();
	...
	public void onEvent(EventDisruptor event, boolean endOfBatch) throws Exception {
		...
		event.getDomainMessage().setEventResult(forum);
	}
